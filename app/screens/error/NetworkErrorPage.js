...
export default class NetworkErrorPage extends React.Component {
  ...
  async componentWillMount() {
    ...
    this.timer = setInterval( async function(){
      ...
      .catch(e => {
        TBB_UTILS.log(5, "-- NetworkErrorPage componentWillMount connectivity e : ", e);
        return null;
      });

      TBB_UTILS.log(5, "-- NetworkErrorPage componentWillMount connectivity : ", connectivity);
  ...
  render() {
    return (
      <View style={{width: LW, height:LH, flex: 1}}>
        ...
        <LinearGradient
          colors={[Colors.bkGradientStart, Colors.bkGradientEnd]}
